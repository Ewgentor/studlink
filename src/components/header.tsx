    ...
    <div className="flex justify-between px-8 py-4 border-b bg-black"> 
      <div className="flex items-center">
        ...
        <div className="flex justify-content-around">
          {
            session?.user.role === "company" ? <Link href="/jobs" className=" text-white ml-20 font-bold"> Создать <br /> задание </Link> : <Link href="/bid" className=" text-white ml-20 font-bold"> Список <br /> откликов </Link>
          }
