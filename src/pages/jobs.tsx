...
export default function Test(){
    ...
    return (
        <>
        <Head>
            <title>StudLink - Заказы</title>
            <meta name="description" content="Generated by create-t3-app" />
            <link rel="icon" href="/favicon.ico" />
        </Head>
        <main className="flex min-h-screen justify-evenly items-center bg-[url(/all.jpg)] bg-cover bg-center text-white ">
        ...
        <>
            <div className="">
                ...
                <label htmlFor="" className="flex items-center my-3">
                    <p className="text-lg font-bold pr-5">Подкатегория:</p>
